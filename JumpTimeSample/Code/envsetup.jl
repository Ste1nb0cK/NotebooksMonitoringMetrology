...
Pkg.add(["DifferentialEquations", "LinearAlgebra",
        "Distributed", "DelimitedFiles", "TOML", "JLD2", "SharedArrays", "Mmap"])
# Base.Threads
Pkg.instantiate()
Pkg.precompile()
Pkg.resolve()
using DifferentialEquations, LinearAlgebra, Distributed, DelimitedFiles, TOML, JLD2, SharedArrays, Mmap
